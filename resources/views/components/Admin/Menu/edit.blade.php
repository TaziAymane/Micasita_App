                ...
                <div class="card shadow-sm border-0">
                    ...
                    <div class="card-body px-4 py-3">
                        <form class="needs-validation" method="POST"
                            action="{{ route('menu.update', $item->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <!-- Name Field -->
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control form-control-lg" name="categorie_name"
                                    value="{{ old('categorie_name', $item->categorie_name) }}">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="time_take" value="{{ old('time_take', $item->time_take) }}" />
                            </div>
